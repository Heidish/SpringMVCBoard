	...
	<script type="text/javascript">
		...
		function fn_addFile(){
			...
			$(".fileAdd_btn").on("click", function(){
				$("#fileIndex").append("<div><input type='file' style='float:left;' name='file_"+(fileIndex++)+"'>"+"</button>"+"<button type='button' style='float:right;' id='fileDel_btn'>"+"삭제"+"</button></div>");
			});
					...
					<tr>
						<td id="fileIndex">
							...
							<div>
								...
								<button id="fileDel_btn" onclick="fn_del('${file.FILE_NO}','FILE_NO_${var.index}');" type="button">삭제</button><br>
							</div>
							</c:forEach>
						</td>
					</tr>	
